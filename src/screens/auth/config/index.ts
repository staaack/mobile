...
export const googleAuthConfig: ConfigureParams = {
  webClientId:
    '7109408676-mlfk5ib9kc6i3df2akdj5offuguo6as0.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
